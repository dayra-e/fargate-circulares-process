...
Si el tipo de documento de identidad es C.I. entonces el NUMERO DE DOCUMENTO DE IDENTIDAD es una serie de digitos  que tienen c por delante y dos letras que pueden ser: LP, SC, CO, OR, PO, BE, TJ, PA, CH, TA, CB, PT.
...
El NUMERO TIPO DE RESPALDO corresponde al numero de NUREJ, PIET o IANUS y es un numero de 8 a 10 digitos que tienen c por delante.
IMPORTANTE: si cualquier codigo tiene c adelante colocalo en el json con la c (ejemplo: c01345678)
...
"NUMERO DE DOCUMENTO DE IDENTIDAD": "c3547170 LP"
}},
{{
"APELLIDO PATERNO": "MAMANI",
...
"RAZON SOCIAL": "",
"TIPO DE DOCUMENTO DE IDENTIDAD": "C.I.",
"NUMERO DE DOCUMENTO DE IDENTIDAD": "c4061121 SC"
}},
{{
...
"RAZON SOCIAL": "",
"TIPO DE DOCUMENTO DE IDENTIDAD": "C.I.",
"NUMERO DE DOCUMENTO DE IDENTIDAD": "c3090751 PO"
}}],
...
"NUMERO TIPO DE RESPALDO": "c20410539",
...
"NUMERO DE DOCUMENTO DE IDENTIDAD": "c193834025"
}}],
...
"DOCUMENTO DE RESPALDO": "NUREJ",
"NUMERO TIPO DE RESPALDO": "c204129970",
"NOMBRE DE LA AUTORIDAD SOLICITANTE": "IVER FERNANDO ROMERO FONTANA",
"NOMBRE DEL JUZGADO": "JUEZ PUBLICO CIVIL Y COMERCIAL NRO 17"}}
...
{{"NUMERO DE CITE": "OFICIO N° 369/2024",
 ...
 "DEMANDADOS": [{{"APELLIDO PATERNO": "AGUILAR",
   ...
   "RAZON SOCIAL": "",
   "TIPO DE DOCUMENTO DE IDENTIDAD": "C.I.",
   "NUMERO DE DOCUMENTO DE IDENTIDAD": "c6179695 LP"}}],
 "DEMANDANTE": "BANCO UNION S.A.",
 "TIPO DE PROCESO": "COACTIVA",
 "MONEDA": "BS",
 "MONTO A SER RETENIDO": "69,949.35",
 "DOCUMENTO DE RESPALDO": "NUREJ",
 "NUMERO TIPO DE RESPALDO": "c2041518",
...
Ciertas lineas de la tabla pueden ser ineligibles, procesa las lineas solo si son legibles.
...
IMPORTANTE: si cualquier codigo tiene c adelante colocalo en la tabla con la letra c (ejemplo: c01345678)
...
|:-------------------|:-------------------|:------------------|:---------------------------------|:------------------------------------|:---------------|:---------|:----------------------|
| RIOJA              | IRIARTE            | MARIA LUZ         | CI                               | c5296860 CO.                        |                |    BS    |         20.5          |
| GARCIA             | SORIA              | NELY              | CI                               | c8675948 CO.                        |                |    BS    |         40.2          |
| CASTELLON          | MELGAREJO          | LUIS              | CI                               | c524460-10 CO.                      |                |    BS    |         55.2          |
| ZURITA             | JAIMES             | CLAUDIO           | NIT                              | c5309221017                         |                |    BS    |         10.5          |
        """},
    {'role': 'user',
...
El NOMBRE DE LA CIUDAD DEL SOLICITANTE corresponde a la ciudad en Bolivia de donde viene la demanda.	
El DOCUMENTO DE RESPALDO puede ser: NUREJ, PIET o IANUS. 
El NUMERO TIPO DE RESPALDO corresponde al numero de NUREJ, PIET o IANUS y es un numero de 8 a 9 digitos.
...
{{
  ...
  "DOCUMENTO DE RESPALDO": "NUREJ",
  "NUMERO TIPO DE RESPALDO": "c20160399",
...
{{
  "NOMBRE DE LA CIUDAD DEL SOLICITANTE": "LA PAZ",
  "DOCUMENTO DE RESPALDO": "NUREJ",
  "NUMERO TIPO DE RESPALDO": "c1210271843",
...
Ejemplo 1: JUZGADO PUBLICO CIVIL Y COMERCIAL NRO 6 LA PAZ
Ejemplo 2: JUZGADO PUBLICO CIVIL Y COMERCIAL NRO 1 TRINIDAD
Ejemplo 3: JUZGADO DE TRABAJO Y SEGURIDAD SOCIAL NRO 3 SANTA CRUZ
Ejemplo 4: JUZGADO PUBLICO MIXTO CIVIL COMERCIAL DE FAMILIA NINEZ Y ADOLECENSIA E INTRUCCION PENAL NRO 1 EL TORNO
Ejemplo 5: JUZGADO PUBLICO CIVIL COMERCIAL Y DE SENTENCIA PENAL NRO 1 COMARAPA COCHABAMBA
Ejemplo 6: JUZGADO DE PARTIDO LIQUIDADOR Y SENTENCIA NRO 4 EL ALTO"""}]
...
"TIPO DE CASO":"NUREJ",
"NUMERO DOCUMENTO DE RESPALDO ":"c8078378",
...
{{
"NOMBRE DE LA CIUDAD DEL SOLICITANTE":"La Paz",
"FECHA DE PUBLICACION":"15/05/2024",
...
"TIPO DE CASO":"IANUS",
"NUMERO DOCUMENTO DE RESPALDO ":"c1208317322",
